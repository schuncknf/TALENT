...
class solver
{
    private:
        ...
        int Number_of_protons, Number_of_neutrons;
        int Nbasis, Nparticles;
...
\
        ...
        solver(physical_world * pass_object, unsigned int max_iterations, double conv_treshold, int N_n, int N_p);
